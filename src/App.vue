...
@keyframes gridMove {
  ...
  100% { transform: rotateX(60deg) translateZ(-100px) translateY(60px); }
}
...
/* ...tambah random lainnya agar tersebar */
@keyframes floatUp {
...
/* 5. SHOOTING STARS (Meteor) */
.shooting-star {
  position: absolute;
  top: 0; left: 50%;
  width: 2px; height: 100px;
  background: linear-gradient(to bottom, rgba(255,255,255,0), rgba(255,255,255,0.4));
  animation: meteor 4s infinite linear;
  opacity: 0;
}
...
@keyframes meteor {
  ...
  10% { opacity: 0.5; }
  20% { transform: translateY(100vh); opacity: 0; }
  100% { opacity: 0; }
}
